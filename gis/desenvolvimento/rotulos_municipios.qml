...
<qgis version="2.14.11-Essen" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="CD_GEOCODM">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="NM_MUNICIP">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/Size" value="1~~1~~CASE&#xa;WHEN  $map='Mapa2 Localização' THEN 12&#xa;WHEN  $map='Mapa3 Localização' THEN 8&#xa;ELSE 12&#xa;END~~"/>
    ...
    <property key="labeling/fieldName" value="wordwrap(NM_MUNICIP,5)"/>
    <property key="labeling/fitInPolygonOnly" value="false"/>
    <property key="labeling/fontCapitals" value="0"/>
    <property key="labeling/fontFamily" value="Swis721 BT"/>
  ...
  <aliases>
    <alias field="CD_GEOCODM" index="1" name=""/>
    <alias field="ID" index="0" name=""/>
    <alias field="NM_MUNICIP" index="2" name=""/>
  </aliases>
